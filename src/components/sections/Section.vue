<script setup>
const props = defineProps([ 'caption', 'heading' ]);
</script>

<template>
  <div :class="`max-w-full flex justify-center bg-gray-100 odd:bg-gray-300 dark:bg-secondary-dark dark:odd:bg-secondary py-16 px-8`">
